...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <center><h2 style="color:#d7385e;">Search
            </h2></center>
            <center>Note: Enter part of name or part of hallticket no. that it will show all the matching names </center>
          </div>
                        
                    <form action="" method="POST">  
<center><input class="input-group-text" id="inputGroup-sizing-sm" type="text" name='htno' placeholder="Search by"></center>             
<center><button type="submit" class="btn btn-primary">View</button></center>
                      ...
                      <?php
                       if($_SERVER["REQUEST_METHOD"]=="POST"){
                           ...
                           $search=$_POST['htno'];
                           $a="select bname,concat(first_name,' ',last_name) as name,hall_ticket,student_phno,sid,permanent_address,quota  from students a left join branches b on a.branch=b.bid where hall_ticket like '%".$search."%' or concat(first_name,' ',last_name) like '%".$search."%'";
                        ...
                        if (mysqli_num_rows(mysqli_query($mysql, $a))>0) {
                                ...
                                <thead><tr>
                                    ...
                                    <td>'.'<a href=viewstudent.php?id='.$row['sid'].' class="btn btn-primary btn-sm">View</a><a href=updatestudent.php?id='.$row['sid'].' class="btn btn-danger btn-sm">Edit</a>'.'<a href=vaa.php?id="'.$row['hall_ticket'].'" class="btn btn-warning btn-sm">Attendance</a>'.'</td>
                                    </tr>';
