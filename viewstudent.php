...
if(isset($_GET['id']) && is_numeric($_GET['id'])){
    ...
    $userid = $_GET['id'];
    $get_user = mysqli_query($mysql,"SELECT b.bname,a.*,pcase(concat(First_Name,' ',Last_Name)) as name FROM `students` a left join branches b on a.branch=b.bid WHERE sid='$userid'");
                ...
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                      ...
                      <p class="text-secondary mb-1"><?php echo $row['Hall_Ticket'];?></p>
                      <p class="text-muted font-size-sm"><?php echo $row['Student_PhNo'];?></p>
                      <button class="btn btn-primary"><?php echo $row['user_email'];?></button>
              ...
              <div class="card mb-3">
                <div class="card-body">
                  <div class="row">
                    ...
                    <?php echo strtoupper($row['Hall_Ticket']);?>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0">Regulation</h6>
                    </div>
                    <div class="col-sm-9 text-secondary">
                    <?php echo $row['regulation'];?>
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0">Join Year</h6>
                    </div>
                    <div class="col-sm-9 text-secondary">
                    <?php echo $row['joined_year'];?>
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0">Parent_PhNo</h6>
                    </div>
                    <div class="col-sm-9 text-secondary">
                    <?php echo $row['Parent_PhNo'];?>
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0">Bus Transport</h6>
                    </div>
                    <div class="col-sm-9 text-secondary">
                    <?php echo $row['Bus_Transport'];?>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0">College Fee</h6>
                    </div>
                    <div class="col-sm-9 text-secondary">
                    <?php echo $row['College_Fee'];?>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
